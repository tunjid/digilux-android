...
object ItemSorter {
    ...
    const val ENABLE_ACCESSIBILITY_BUTTON = WALLPAPER_TRIGGER + 1
    ...
    const val BUBBLES_POPUP = ANIMATES_POPUP + 1
    const val POPUP_POSITION = BUBBLES_POPUP + 1
    const val POPUP_ACTION = POPUP_POSITION + 1
    const val ENABLE_WATCH_WINDOWS = POPUP_ACTION + 1
    const val ROTATION_LOCK = ENABLE_WATCH_WINDOWS + 1
    const val EXCLUDED_ROTATION_LOCK = ROTATION_LOCK + 1
    const val DISCRETE_BRIGHTNESS = BUBBLES_POPUP + 1
...
private val tabItems = listOf(
    ...
    Tab.PopUp to intArrayOf(
        ...
        ItemSorter.ANIMATES_POPUP, ItemSorter.BUBBLES_POPUP, ItemSorter.POPUP_POSITION,
        ItemSorter.POPUP_ACTION, ItemSorter.ENABLE_WATCH_WINDOWS,
